...
int main(int argc, char *argv[]) {
  ...
  if (covered_villagers.Size() != gifts_and_villagers.GetVillagers().size()) {
    ...
    // TODO NEXT handle this case; test with Pierre; consider printing out something more exact (that they will need a Liked Gift? that is a whole additional idea for this repo)
